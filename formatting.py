...
print(("-" * 20) + "37. String Formatting" + ("-" * 20) + "\n")
...
# > ***You can Provide Any Expressions Inside the .format() Parenthesis. They don’t have to be variables or literal
# numbers.
# > On line 14, we’ve got i **2 ( ** is called Exponent operator) to get the number squared and i ** 3 to get the number
# cubed.
...
# > But as you can see, in the output the values aren’t Lined up.
# *** We can fix the output by applying some Formatting.
...
# > So line 49, we’re using {0: 2} in our left and right curly braces for the first Replacement Field.
...
# 	Maybe a Width the 3 would look better there. Have a go at changing that yourself and see what it looks like.
for i in range(1, 13):
...
# *** We can also Align the values in the Field Width.
# > To Left Align the values, place a < (less than symbol) after the : (colon).
for i in range(1, 13):
    print("No. {0:2} squared is {1:<3} and cubed is {2:<4}".format(i, i ** 2, i ** 3))
print()
# Output:
...
# As we can see, the numbers are aligned to the left when compared to the Output of the code on line 76

# The alignment symbols are quite visual.
#   The < (Less Than Symbol), Left Aligns;
...
# > If you run this code again, you can see the values are now clearly Centered compared to the first output for code
# on line 76, which was right justified on the right-hand side. This is obviously for the cubed values.
...
print()
# > The first line of output that is produced from the code on line 174, is the general format and that defaults to
...
print(len("142857"))        # 6
print()
# > When we specify a floating-point value using the f on line 180, we get the default of 6 digits after the decimal
# point

# > Now on lines 190, 205, 212, 214, & 219, we’re still specifying a floating-point format, but we also add a precision
# of 50 and that gives 50 points (digits) after the decimal point.
...
print()
# > The output corresponds to line 190. If you think it doesn’t look right, that’s because Python won’t truncate a
...
# > Now, the next three lines on 205, 212, 219 print the same value, but in Different field Widths. When we specify
# field Width greater than 50 you can see that the effect becomes clear.
# > The Maximum Precision of a Python Floating-point number is between 51 and 53 digits (after decimal point). There’s
# not much point specifying a precision greater than that.
...
# Output:
# Pi is approximately           3.14285714285714279370154144999105483293533325195312
print(len("          3.14285714285714279370154144999105483293533325195312"))        # 62
print(len("14285714285714279370154144999105483293533325195312"))                    # 50
print()
...
# Output:
# Pi is approximately                     3.14285714285714279370154144999105483293533325195312
print(len("                    3.14285714285714279370154144999105483293533325195312"))   # 72
print(len("14285714285714279370154144999105483293533325195312"))                         # 50
print()
