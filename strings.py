...
# However, if you start a string with one type then you must finish it with the same tupe
print("Today is a good day to learn Python")
print('Python is fun')
# If you need to include a single quote in the string then use double quote in the string and vice-versa
