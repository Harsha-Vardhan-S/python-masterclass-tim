...
# > So let’s rewrite the code on line 11. Instead of using the string function, we’re going to use {} (Replacement
# Fields) and the .format() (Dot Format) Method.
...
# > It’s the field Index, i.e, the number inside the {} curly braces that determines which value to be used.
