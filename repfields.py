...
# 	So, using the string function helps us to basically coerce an Integer into a String.
...
# 	So let’s rewrite the code on line 11. Instead of using the string function, we’re going to use Replacement Fields
# and the Dot Format Method.
...
print()
# 	So I’ll split the code on line 32 over two lines, which is something you’ll see done a lot in Python. Long lines are
...
# the parenthesis after the dot format method call
